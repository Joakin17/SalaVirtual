    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <form action="{{ route('prestamocompus.update', $usuario->id) }}" method="POST" >
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select id="carrera" name="carrera" class="form-control" tabindex="5">
                            ...
                            <option value="Licenciatura en Ciencias de la Educación con Especialidad Direccion y Administracion Escolar" {{ $usuario->carrera == 'Licenciatura en Ciencias de la Educación con Especialidad Direccion y Administracion Escolar' ? 'selected' : '' }}>Licenciatura en Ciencias de la Educación con Especialidad Direccion y Administracion Escolar</option>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <button class="custom-button">Actualizar Usuario</button>
                    </div>
                    <div class="col-md-6">
                        <a href="/usuarios" class="custom-button">Regresar a Usuarios</a>
                    </div>
                </div>
            </form>
        </div>
